...
public class ShoppingRecord {
    ...
    public String getPurchase() {
        return LocalDateTime.ofInstant(purchase, ZoneId.systemDefault()).format(DateTimeFormatter.ofPattern("dd/MM/yyyy hh:mm:ss"));
    }
    public String getDeliver() {
        return LocalDateTime.ofInstant(deliver, ZoneId.systemDefault()).format(DateTimeFormatter.ofPattern("dd/MM/yyyy hh:mm:ss"));
    }
